...
- `custom_dts`: Contains a custom file for the Analog Front-End (AFE) and for the radar sensor (bgt60tr13c)
- `custom_shields`: Contains the custom shield definitions for the ExG (EEG/EMG), PPG and the mmWave sensors.
